...
CAM_FINAL_FWD_S = 2.0         # surge duration once centred
# Game day: the surge is flown at this speed, not the cruise CAM_FWD_SPEED.
# CAM_FINAL_FWD_S * GAME_SURGE_SPEED = how far it travels -- 2.0 s at 1.5 m/s
# is about 3 m, so leave room ahead of the feature.
